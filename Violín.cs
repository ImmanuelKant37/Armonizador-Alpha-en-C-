...
{
    public partial class Violín: Form
    {
        public Violín()
        {
            InitializeComponent();
       ...
       void ArmoniaDO()
        ...
        private void Mostrar_DoubleClick(object sender, EventArgs e)
        {
            Rellenar();
        ...
        private void SolS2_DoubleClick(object sender, EventArgs e)
        {
            ArmoniaLAB();
        }

        private void FaS3_DoubleClick(object sender, EventArgs e)
        {
            ArmoniaFAS();
        }

        private void Fa3_DoubleClick(object sender, EventArgs e)
        {
            ArmoniaFA();
        }

        private void Mi3_DoubleClick(object sender, EventArgs e)
        {
            ArmoniaMI();
        }

        private void La3_DoubleClick(object sender, EventArgs e)
        {
            ArmoniaLA();
        }

        private void Sib3_DoubleClick(object sender, EventArgs e)
        {
            ArmoniaSIB();
        }

        private void Do5_DoubleClick(object sender, EventArgs e)
        {
            ArmoniaDO();
        }

        private void Do4_DoubleClick(object sender, EventArgs e)
        {
            ArmoniaDO();
        }

        private void Reb3_DoubleClick(object sender, EventArgs e)
        {
            ArmoniaREB();
        }

        private void Re3_DoubleClick(object sender, EventArgs e)
        {
            ArmoniaRE();
        }

        private void Sol3_DoubleClick(object sender, EventArgs e)
        {
            ArmoniaSOL();
        }

        private void La4_DoubleClick(object sender, EventArgs e)
        {
            ArmoniaLA();
        }
        ...
        private void Violín_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
            SendMessage(this.Handle, 0x112, 0xf012, 0);
        }
        ...
        private void Mi3_MouseDown(object sender, MouseEventArgs e)
        {
            {
                xR = e.X;
                yR = e.Y;
        ...
        private void Mi3_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ((Label)sender).Location = new Point(((Label)sender).Left + e.X - xR, ((Label)sender).Top + e.Y - yR);
        ...
        //////////////////////////////////////
        private void Fa3_MouseDown(object sender, MouseEventArgs e)
        {
            {
                xR = e.X;
                yR = e.Y;
        ...
        private void Fa3_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ((Label)sender).Location = new Point(((Label)sender).Left + e.X - xR, ((Label)sender).Top + e.Y - yR);
        ...
        private void FaS3_MouseDown(object sender, MouseEventArgs e)
        {
            {
                xR = e.X;
                yR = e.Y;
        ...
        private void FaS3_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ((Label)sender).Location = new Point(((Label)sender).Left + e.X - xR, ((Label)sender).Top + e.Y - yR);
        ...
        private void Sol3_MouseDown(object sender, MouseEventArgs e)
        {
            {
                xR = e.X;
                yR = e.Y;
        ...
        private void Sol3_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ((Label)sender).Location = new Point(((Label)sender).Left + e.X - xR, ((Label)sender).Top + e.Y - yR);
        ...
        private void SolS2_MouseDown(object sender, MouseEventArgs e)
        {
            {
                xR = e.X;
                yR = e.Y;
        ...
        private void SolS2_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ((Label)sender).Location = new Point(((Label)sender).Left + e.X - xR, ((Label)sender).Top + e.Y - yR);
        ...
        private void La3_MouseDown(object sender, MouseEventArgs e)
        {
            {
                xR = e.X;
                yR = e.Y;
        ...
        private void La3_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ((Label)sender).Location = new Point(((Label)sender).Left + e.X - xR, ((Label)sender).Top + e.Y - yR);
        ...
        private void Do5_MouseDown(object sender, MouseEventArgs e)
        {
            {
                xR = e.X;
                yR = e.Y;
        ...
        private void Do5_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ((Label)sender).Location = new Point(((Label)sender).Left + e.X - xR, ((Label)sender).Top + e.Y - yR);
        ...
        private void Sib3_MouseDown(object sender, MouseEventArgs e)
        {
            {
                xR = e.X;
                yR = e.Y;
        ...
        private void Sib3_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ((Label)sender).Location = new Point(((Label)sender).Left + e.X - xR, ((Label)sender).Top + e.Y - yR);
        ...
        private void Do4_MouseDown(object sender, MouseEventArgs e)
        {
            {
                xR = e.X;
                yR = e.Y;
        ...
        private void Do4_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ((Label)sender).Location = new Point(((Label)sender).Left + e.X - xR, ((Label)sender).Top + e.Y - yR);
        ...
        private void Reb3_MouseDown(object sender, MouseEventArgs e)
        {
            {
                xR = e.X;
                yR = e.Y;
        ...
        private void Reb3_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ((Label)sender).Location = new Point(((Label)sender).Left + e.X - xR, ((Label)sender).Top + e.Y - yR);
        ...
        private void Re3_MouseDown(object sender, MouseEventArgs e)
        {
            {
                xR = e.X;
                yR = e.Y;
        ...
        private void La4_MouseDown(object sender, MouseEventArgs e)
        {
            {
                xR = e.X;
                yR = e.Y;
        ...
        private void La4_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ((Label)sender).Location = new Point(((Label)sender).Left + e.X - xR, ((Label)sender).Top + e.Y - yR);
